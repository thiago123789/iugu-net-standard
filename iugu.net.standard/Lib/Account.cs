...
namespace iugu.net.standard.Lib
{
    ...
    public class Account : IDisposable
    {
        ...
        {
            return VerifyUnderAccountAsync(accountData, accountId, userToken).Result;
        }
        ...
        {
            return await Api.PostAsync<VerifyAccountResponseMessage>(accountData, $"{accountId}/request_verification", userToken).ConfigureAwait(false);
        }
        ...
        {
            return await Api.GetAsync<GetAccountResponseMessage>(accountId, userToken).ConfigureAwait(false);
        }
        ...
        {
            return await RequestWithdrawAsync(targetAccountId, amount, null).ConfigureAwait(false);
        }
        ...
        {
            return await Api.PostAsync<AccountRequestWithdrawResponse>(new { amount = amount }, $"{targetAccountId}/request_withdraw", customUserApiToken).ConfigureAwait(false);
        }
        ...
        {
            return await RequestWithdrawAllAsync(targetAccountId, null).ConfigureAwait(false);
        }
        ...
        public async Task<AccountRequestWithdrawResponse> RequestWithdrawAllAsync(string targetAccountId, string customUserApiToken)
        {
            ...
            return await Api.PostAsync<AccountRequestWithdrawResponse>(new { amount = convertedValue }, $"{targetAccountId}/request_withdraw", customUserApiToken).ConfigureAwait(false);
        }
